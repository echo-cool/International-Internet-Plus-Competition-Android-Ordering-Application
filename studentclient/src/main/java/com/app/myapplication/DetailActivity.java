...
import com.app.myapplication.adapters.DetailAdapter;
import com.app.myapplication.behaviors.DetailHeaderBehavior;
...
public class DetailActivity extends BaseActivity implements AddWidget.OnAddWidgetClick{
	...
	private void initViews() {
		...
		if(foodBean.foodImage!=null)
			iv_detail.setImageBitmap(BitmapFactory.decodeByteArray(foodBean.foodImage,0,foodBean.foodImage.length));
		TextView toolbar_title = (TextView) findViewById(R.id.toolbar_title);
		toolbar_title.setText(foodBean.foodName);
		TextView detail_name = (TextView) findViewById(R.id.detail_name);
		detail_name.setText(foodBean.foodName);
		TextView detail_sale = (TextView) findViewById(R.id.detail_sale);
		detail_sale.setText("日销:"+foodBean.foodSale + " 喜爱:95%");
		((TextView)findViewById(R.id.foodSummary)).setText(foodBean.foodSummary);
		TextView detail_price = (TextView) findViewById(R.id.detail_price);
		detail_price.setText("¥"+foodBean.foodPrice);
	...
	private void initRecyclerView() {
		...
		dAdapter = new DetailAdapter(new ArrayList<>(), this);
	...
	private void initShopCar() {
		...
		//flist.addAll(ShopActivity.carAdapter.getData());
